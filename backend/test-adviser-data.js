...
async function testAdviserData() {
  ...
  try {
    ...
    const newColumns = ['academic_rank', 'employment_status', 'educational_attainment', 
                        'campus', 'telephone_number', 'birth_date', 'age', 'civil_status', 
                        'home_address', 'photo_url', 'signature_url'];
