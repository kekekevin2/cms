...
exports.getPersonalProfile = async (req, res) => {
  try {
    ...
    const record = await db.FacultyPersonalProfile.findOne({
...
exports.upsertPersonalProfile = async (req, res) => {
  try {
    ...
    const existing = await db.FacultyPersonalProfile.findOne({
      where: { faculty_id: facultyId },
    });
    ...
    let profile, created;
    try {
      [profile, created] = await db.FacultyPersonalProfile.upsert({
        ...profileData,
...
exports.getAwards = async (req, res) => {
  try {
    ...
    const rows = await db.FacultyAwards.findAll({
      where: { faculty_id: facultyId },
...
exports.createAward = async (req, res) => {
  try {
    ...
    let award;
    try {
      award = await db.FacultyAwards.create({
        ...awardData,
        faculty_id: facultyId,
      });
    } catch (dbError) {
...
exports.getSeminarsTrainings = async (req, res) => {
  try {
    ...
    const rows = await db.FacultySeminarsTrainings.findAll({
      where: { faculty_id: facultyId },
      order: [["date", "DESC"]],
    });
...
exports.createSeminarTraining = async (req, res) => {
  try {
    ...
    let seminar;
    try {
      seminar = await db.FacultySeminarsTrainings.create({
        ...seminarData,
        faculty_id: facultyId,
      });
    } catch (dbError) {
...
exports.getResearchActivities = async (req, res) => {
  try {
    ...
    const rows = await db.FacultyResearchActivities.findAll({
      where: { faculty_id: facultyId },
      order: [["date", "DESC"]],
    });
...
exports.createResearchActivity = async (req, res) => {
  try {
    ...
    let activity;
    try {
      activity = await db.FacultyResearchActivities.create({
        ...activityData,
        faculty_id: facultyId,
      });
    } catch (dbError) {
...
exports.getExtensionActivities = async (req, res) => {
  try {
    ...
    const rows = await db.FacultyExtensionActivities.findAll({
      where: { faculty_id: facultyId },
...
exports.createExtensionActivity = async (req, res) => {
  try {
    ...
    let activity;
    try {
      activity = await db.FacultyExtensionActivities.create({
        ...activityData,
        faculty_id: facultyId,
      });
    } catch (dbError) {
